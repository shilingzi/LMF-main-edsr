...
import models
import models.lmlte_edsr  # 导入EDSR-LMLTE模型
import utils
from datasets import make_dataset, make_data_loader

from models.lmlte_edsr import LMLTE_EDSR  # 确保导入LMLTE_EDSR模型
...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', default='configs/train-lmf/train_edsr-lmlte_new.yaml')
    parser.add_argument('--save_dir', default='save/edsr_lm-lmlte_new')
